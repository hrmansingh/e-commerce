...
export default function SignUp() {
  ...
  return (
    ...
    <div className="input_container">
      ...
      <input placeholder="Enter the Name" title="Name" name="name" type="text" className="input_field" id="Name" onChange={(e)=> setName(e.target.value)} value={name}/>
    </div>
    <div className="input_container">
      ...
      <input placeholder="Enter the Email" title="Email" name="email" type="text" className="input_field" id="email_field" onChange={(e)=> setEmail(e.target.value)} value={email}/>
    </div>
    <div className="input_container">
      ...
      <input placeholder="Password" title="Password" name="password" type="password" className="input_field" id="password_field" onChange={(e)=>setPassword(e.target.value)} value={password}/>
    </div>

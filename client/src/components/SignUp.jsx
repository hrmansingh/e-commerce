...
export default function SignUp() {
  ...
  async function submitForm(e){
    e.preventDefault();
    try {
        const result = fetch('http://localhost:3000/user',{
         method:"POST",
  ...
  return (
    ...
    <div className="input_container">
      ...
      className="icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
      <input placeholder="Enter the Name" title="Name" name="name" type="text" className="input_field" id="Name" onChange={(e)=> setName(e.target.value)} />
    </div>
    <div className="input_container">
      ...
      <input placeholder="Enter the Email" title="Email" name="email" type="text" className="input_field" id="email_field" onChange={(e)=> setEmail(e.target.value)}/>
    </div>
    <div className="input_container">
      ...
      <input placeholder="Password" title="Password" name="password" type="password" className="input_field" id="password_field" onChange={(e)=>setPassword(e.target.value)}/>
    </div>
    <button title="Sign In"  type="submit" className="sign-in_btn" >
      <span>Sign Up</span>
    </button>
    <NavLink className='sign-btn-link' to={'/signIn'}>
      <span className='create-account-span02'><i className="fa-solid fa-arrow-left"></i> Back</span>
    </NavLink>
